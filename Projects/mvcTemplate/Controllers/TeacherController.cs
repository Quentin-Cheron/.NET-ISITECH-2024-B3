        ...
        public IActionResult GenerateTeacherPdf(int id)
        {
            ...
            var pdf = Document.Create(container =>
            {
                container.Page(page =>
                {
                    ...
                    {
                        column.Spacing(10);
                        column.Item().Text($"Full Name: {teacher.Firstname} {teacher.Lastname}");
                        column.Item().Text($"Age: {teacher.Age}");
                        column.Item().Text($"Email: {teacher.Email}");
                    });
            ...
            return File(pdf, "application/pdf", $"{teacher.Firstname}_{teacher.Lastname}_Info.pdf");
        }

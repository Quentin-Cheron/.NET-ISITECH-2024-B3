...
!(function (t, e) {
  ...
  const t = (t) => {
    ...
    n = (t) => {
      t.dispatchEvent(new Teacher("transitionend"));
    },
    s = (t) =>
      !(!t || "object" != typeof t) &&
  ...
  class Xe extends H {
    ...
    show() {
      ...
      const t = P.trigger(this._element, this.constructor.Teacher.SHOW),
        e = c(this._element),
        i =
          null === e
      ...
      M.set(n, this.constructor.DATA_KEY, this),
        this._element.ownerDocument.documentElement.contains(this.tip) ||
          (a.append(n),
          P.trigger(this._element, this.constructor.Teacher.INSERTED)),
        this._popper
          ? this._popper.update()
      ...
      this._queueCallback(
        () => {
          ...
          (this._hoverState = null),
            P.trigger(this._element, this.constructor.Teacher.SHOWN),
    ...
    hide() {
      ...
      if (
        P.trigger(this._element, this.constructor.Teacher.HIDE).defaultPrevented
      )
        return;
      ...
      this._queueCallback(
        () => {
          this._isWithActiveTrigger() ||
            ...
            P.trigger(this._element, this.constructor.Teacher.HIDDEN),
